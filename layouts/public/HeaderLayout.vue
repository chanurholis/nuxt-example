        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6">
            <div class="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                ...
                <nav class="hidden space-x-10 md:flex">
                    <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Whats My IP</a>
                    <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">IP Location</a>
                </nav>
                <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                    <a href="#" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Sign in</a>
                    <ButtonComponent name="Sign up" type="primary" class="ml-8" />
                </div>
            </div>
        </div>
